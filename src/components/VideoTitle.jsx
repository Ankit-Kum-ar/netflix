  ...
  return (
    <div className='px-2 mx-[5%] absolute text-white my-[30%] ' >
      ...
      <div className=' flex gap-4'>
        <button className='bg-white hover:bg-gray-400 shadow-md flex text-black px-6 my-2 py-2'>
            <span className='my-1 px-2'><FaPlay /></span>  Play 
        </button>
        <button className=' flex bg-gray-500 shadow-md text-white px-3 my-2 py-2'>
